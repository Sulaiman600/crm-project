    ...
    <div id="cam-gesture-panel" style="display:none;">
        ...
        <div id="cam-gesture-body">
            ...
            <div id="cam-gesture-menu">
                ...
                <ul id="cam-menu-list">
                    <?php $__currentLoopData = $gestureNavJs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="cam-menu-item"
                            data-url="<?php echo e($item['url']); ?>"
                            data-label="<?php echo e($item['label']); ?>">
                            <span class="cam-menu-icon"><?php echo e($item['icon']); ?></span>
                            <span class="cam-menu-label"><?php echo e($item['label']); ?></span>
                        </li>
...
(function () {
    ...
    const navItems = <?php echo json_encode($gestureNavJs, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\dbms_p\packages\Webkul\Admin\src/resources/views/components/layouts/camera-gesture-widget.blade.php ENDPATH**/ ?>